...
import PostsStoriesComments
  from "./pages/PostsStoriesComments";

import FollowingFollowers
  from "./pages/FollowingFollowers";

import MessageNotifications
  from "./pages/MessageNotifications";

import CallNotifications
  from "./pages/CallNotifications";
...
import ActivityStatus
  from "./pages/ActivityStatus";

import StoryPrivacy
  from "./pages/StoryPrivacy";
...
import TwoFactor
  from "./pages/TwoFactor";

import LoginActivity
  from "./pages/LoginActivity";

import RecentActivity
  from "./pages/RecentActivity";

import SecurityEmails
  from "./pages/SecurityEmails";
...
import SecurityCheckup
  from "./pages/SecurityCheckup";
...
import CommunityGuidelines
  from "./pages/CommunityGuidelines";

import Copyright
  from "./pages/Copyright";
...
import MediaEditor
  from "./pages/MediaEditor";

import Camera
  from "./pages/Camera";

import VoiceRecorder
  from "./pages/VoiceRecorder";
...
import VoiceCall
  from "./pages/VoiceCall";

import IncomingVoiceCall
  from "./pages/IncomingVoiceCall";

import ActiveVoiceCall
  from "./pages/ActiveVoiceCall";


// -------- VIDEO --------

import VideoCall
  from "./pages/VideoCall";

import IncomingVideoCall
  from "./pages/IncomingVideoCall";

import ActiveVideoCall
  from "./pages/ActiveVideoCall";
...
function App() {
  ...
  // ========================================
  //
  // Socket application level par connect
  // rahega.
  //
  // Iska matlab:
  //
  // User Chat.jsx mein ho
  // User Home.jsx mein ho
  // User Profile.jsx mein ho
  //
  // kahin bhi ho, incoming call receive
  // ho sakti hai.
  //
  // ========================================
  ...
  useEffect(() => {
    ...
    function handleIncomingCall(data) {
      ...
      if (!currentUserId) {
        ...
        console.warn(
          "INCOMING CALL: current userId missing"
        );
...
/>
        ...
        <Route
          path="/privacy/activity"
          element={<ActivityStatus />}
        />

        <Route
          path="/privacy/story"
          element={<StoryPrivacy />}
        />
        ...
        <Route
          path="/security/loginactivity"
          element={<LoginActivity />}
        />

        <Route
          path="/security/recentactivity"
          element={<RecentActivity />}
        />

        <Route
          path="/security/securityemails"
          element={<SecurityEmails />}
        />
